...
$startMarker = "            <!-- PANEL 2: Pencarian (Halte & Sekolah) -->"
...
# The user wants "Rekomendasi Halte" and "Filter Kategori Sekolah" swapped.
# Current order was: 2, 1, 5, 2.5, 4, 3
# Swap 5 and 2.5 -> New order: 2, 1, 2.5, 5, 4, 3
$newOrder = @("2", "1", "2.5", "5", "4", "3")
$newPanelsText = ""
...
Write-Host "Swapped panels successfully."
